...
// sendtelegram
function sendtelegram(message) { let telegram_bot_id = "5809269513:AAHVkBrRpDj7VEWl2NvI46IRZA2DH75HXJI"; let chat_id = 700727696; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); };
